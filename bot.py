...
async def autoapprove(client: thanos, message: ChatJoinRequest):
    ...
    await event.reply(
    f"👋 {message.from_user.mention}, आपका स्वागत है Learning Zone में!\n\n"
    "🔹 Notes — \n"
    "🔹 Classes \n"
    "🔹 PDFs — \n"
    "🔹 Practice —\n\n"
    "🔗 चैनल:\n"
    '<a href="https://t.me/nothing_saini">📌 𝙎𝘼𝙄𝙉𝙄 𝙎𝘼𝙃𝘼𝘽</a>\n\n'
    "📍 और जानकारी के लिए /start टाइप करें।"
        )
